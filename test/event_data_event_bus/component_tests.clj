...
(deftest should-accept-good-events
...
(deftest should-reject-events-not-matching-token
...
(deftest should-reject-unsigned-events
...
(deftest should-reject-duplicate-events
  ; TODO
)

(deftest should-assign-timestamps
  ; TODO
)
